  ...
  return (
    <section className="@container bg-vn-dshade-black pt-10 px-16 flex w-full h-full justify-center overflow-y-auto overflow-x-hidden">
      <ReactCodeMirror
        ...
        value={input}
        onChange={onChange}
        className="markdown-editor flex flex-1 flex-col max-[450px]:min-w-[290px] @[500px]:w-[900px] @[1000px]:w-[900px] font-medium focus-within:border-t-[3px] text-[.8rem] border-none "
        height="fit"
        extensions={[
