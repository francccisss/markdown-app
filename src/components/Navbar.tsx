		...
		>
			<div id="left" className="flex ">
				<button
					...
					className="btn-actions bg-nav-sb-icon bg-cover bg-no-repeat w-6 h-6 bg-center"
				/>
			</div>
			<div id="right" className="ml-auto flex">
				<Link
					to={"/app/info/vim-shortcuts"}
					className="btn-actions bg-nav-info-icon bg-cover bg-no-repeat w-6 h-6 bg-center inline-block mr-5"
				/>
				<button className="btn-actions bg-nav-more-icon bg-cover bg-no-repeat w-6 h-6 bg-center inline-block" />
			</div>
		</nav>
	);
};
