...
const Sidebar = ({ notes, sideBarRef, addNote }: ISidebarProps) => {
  ...
  return (
    <div
      id="sidebar"
      ref={sideBarRef}
      className="sidebar-inactive z-10 bg-vn-black flex flex-col max-[720px]:left-10 h-full max-[720px]:h-[97vh] max-[720px]:absolute max-[400px]:left-0 max-[400px]:h-[100dvh]"
    >
      <SidebarActions
